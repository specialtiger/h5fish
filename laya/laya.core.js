...
var Laya = window.Laya = function(window, document) {
    var Laya = {
        ...
        __substr: function(ofs, sz) {
            return arguments.length == 1 ? Laya.__presubstr.call(this, ofs) : Laya.__presubstr.call(this, ofs, sz > 0 ? sz : this.length + sz);
        },
        ...
        __extend: function(d, b) {
            for (var p in b) {
                ...
                if (g || s) {
                    if (g && s) Object.defineProperty(d, p, gs); else {
        ...
        __typeof: function(o, value) {
            ...
            if (value.__interface__) value = value.__interface__; else if (typeof value != "string") return o instanceof value;
        ...
        class: function(o, fullName, _super, miniName) {
            ...
            if (fullName) {
                ...
                if (fullName.indexOf(".") > 0) {
                    ...
                    if (fullName == "Main") window.Main = o; else {
                        if (Laya[fullName]) {
        ...
        getset: function(isStatic, o, name, getfn, setfn) {
            ...
            if (getfn && setfn) Object.defineProperty(o, name, {
                get: getfn,
                set: setfn,
                enumerable: false
            }); else {
        ...
        static: function(_class, def) {
            for (var i = 0, sz = def.length; i < sz; i += 2) {
                if (def[i] == "length") _class.length = def[i + 1].call(_class); else {
                    function tmp() {
                        var name = def[i];
                        var getfn = def[i + 1];
...
(function(window, document, Laya) {
	...
	*/
    //class laya.utils.RunDriver
        ...
        __static(RunDriver, [ "hanzi", function() {
    ...
    //class Laya
		...
		*/
        __getset(1, Laya, "alertGlobalError", null, function(value) {
            ...
            if (value) {
                Browser.window.onerror = function(msg, url, line, column, detail) {
                    if (erralert++ < 5 && detail) alert("出错啦，请把此信息截图给研发商\n" + msg + "\n" + detail.stack);
                };
            } else {
        ...
        Laya.getUrlPath = function() {
            ...
            URL.rootPath = URL.basePath = URL.getPath(window.newBasePath);
        };
        ...
        __static(Laya, [ "conchMarket", function() {
            return this.conchMarket = /*__JS__ */ window.conch ? conchMarket : null;
	...
	*/
    //class laya.display.css.Style
        ...
        /**元素应用的 2D 或 3D 转换的值。该属性允许我们对元素进行旋转、缩放、移动或倾斜。*/        __getset(0, __proto, "transform", function() {
            return this.getTransform();
        }, function(value) {
            this.setTransform(value);
        });
        /**定义转换，只是用 X 轴的值。*/        __getset(0, __proto, "translateX", function() {
            return this._tf.translateX;
        }, function(value) {
            this.setTranslateX(value);
        });
        /**定义转换，只是用 Y 轴的值。*/        __getset(0, __proto, "translateY", function() {
            return this._tf.translateY;
        }, function(value) {
            this.setTranslateY(value);
        });
        /**Y 轴缩放值。*/        __getset(0, __proto, "scaleY", function() {
            return this._tf.scaleY;
        }, function(value) {
            this.setScaleY(value);
        });
        /**表示元素是否显示为块级元素。*/        __getset(0, __proto, "block", function() {
            return (this._type & 1) != 0;
        });
        /**定义沿着 Y 轴的 2D 倾斜转换。*/        __getset(0, __proto, "skewY", function() {
            return this._tf.skewY;
        }, function(value) {
            this.setSkewY(value);
        });
        /**定义旋转角度。*/        __getset(0, __proto, "rotate", function() {
            return this._tf.rotate;
        }, function(value) {
            this.setRotate(value);
        });
        /**定义沿着 X 轴的 2D 倾斜转换。*/        __getset(0, __proto, "skewX", function() {
            return this._tf.skewX;
        }, function(value) {
            this.setSkewX(value);
        });
        /**表示元素的左内边距。*/        __getset(0, __proto, "paddingLeft", function() {
            return 0;
        });
        /**表示元素的上内边距。*/        __getset(0, __proto, "paddingTop", function() {
            return 0;
        });
        /**是否为绝对定位。*/        __getset(0, __proto, "absolute", function() {
            return true;
        });
    ...
    //class laya.display.css.Font
		...
		*/;
        __getset(0, __proto, "password", function() {
            ...
            value ? this._type |= 1024 : this._type &= ~1024;
        });
        /**
		*表示颜色字符串。
		...
		*/        __getset(0, __proto, "italic", function() {
            ...
            value ? this._type |= 512 : this._type &= ~512;
        });
        /**
		*表示是否为粗体。
		*/        __getset(0, __proto, "bold", function() {
            ...
            value ? this._type |= 2048 : this._type &= ~2048;
        });
        /**
		*文本的粗细。
    ...
    //class laya.display.Graphics
		...
		*/;
        __proto.clear = function(recoverCmds) {
            ...
            this._one = null;
            this._render = this._renderEmpty;
            this._sp && (this._sp._renderType &= ~/*laya.renders.RenderSprite.IMAGE*/ 1);
            this._sp && (this._sp._renderType &= ~/*laya.renders.RenderSprite.GRAPHICS*/ 512);
            this._repaint();
        ...
        __proto.replaceText = function(text) {
            ...
            if (!cmds) {
                if (this._one && this._isTextCmd(this._one.callee)) {
                    if (this._one[0].toUpperCase) this._one[0] = text; else this._one[0].setText(text);
                    return true;
                }
            } else {
                for (var i = cmds.length - 1; i > -1; i--) {
                    if (this._isTextCmd(cmds[i].callee)) {
                        if (cmds[i][0].toUpperCase) cmds[i][0] = text; else cmds[i][0].setText(text);
                        return true;
                    }
                }
            }
		...
		*/;
        __proto.loadImage = function(url, x, y, width, height, complete) {
            ...
            if (tex) onloaded(tex); else Laya.loader.load(url, Handler.create(null, onloaded), null, /*laya.net.Loader.IMAGE*/ "image");
		...
		*/;
        __proto._renderOneImg = function(sprite, context, x, y) {
            ...
            if (sprite._renderType !== 2305) {
                sprite._renderType |= /*laya.renders.RenderSprite.IMAGE*/ 1;
            }
        }
        /**
		*绘制一条线。
		...
		*/;
        __proto.drawPoly = function(x, y, points, fillColor, lineColor, lineWidth) {
            ...
            var offset = lineColor ? lineWidth % 2 === 0 ? 0 : .5 : 0;
	...
	*/
    //class laya.display.GraphicsBounds
		...
		*/;
        __proto.getBoundPoints = function(realSize) {
            realSize === void 0 && (realSize = false);
            if (!this._temp || this._temp.length < 1 || realSize != this._cacheBoundsType) this._temp = this._getCmdPoints(realSize);
            this._cacheBoundsType = realSize;
        ...
        __static(GraphicsBounds, [ "_tempMatrix", function() {
	...
	*/
    //class laya.events.Event
		...
		*/        __getset(0, __proto, "shiftKey", function() {
        ...
        /**鼠标在 Stage 上的 X 轴坐标*/        __getset(0, __proto, "stageX", function() {
	...
	*/
    //class laya.events.KeyBoardManager
        ...
        KeyBoardManager._dispatch = function(e, type) {
            ...
            if (type === "keydown") KeyBoardManager._pressKeys[KeyBoardManager._event.keyCode] = true; else if (type === "keyup") KeyBoardManager._pressKeys[KeyBoardManager._event.keyCode] = null;
        ...
        __static(KeyBoardManager, [ "_event", function() {
		...
		*/        __proto.__init__ = function(stage, canvas) {
        ...
        __proto.onMouseDown = function(ele) {
            if (Input.isInputting && Laya.stage.focus && Laya.stage.focus["focus"] && !Laya.stage.focus.contains(this._target)) {
                ...
                if (new_input instanceof laya.display.Input && new_input.multiline == pre_input.multiline) pre_input["_focusOut"](); else pre_input.focus = false;
            }
		...
		*/;
        __proto.runEvent = function() {
            ...
            while (i < len) {
                ...
                if (evt.type !== "mousemove") this._prePoint.x = this._prePoint.y = -1e6;
                switch (evt.type) {
                  case "mousedown":
        ...
        __static(MouseManager, [ "instance", function() {
    ...
    //class laya.events.TouchManager
		...
		*/;
        __proto.onMouseDown = function(ele, touchID, isLeft) {
            ...
            if (Browser.onMobile) this.sendEvents(arrs, /*laya.events.Event.MOUSE_OVER*/ "mouseover", touchID);
            var preDowns;
		...
		*/;
        ...
        __static(TouchManager, [ "I", function() {
	...
	*/
    //class laya.filters.Filter
        ...
        /**@private 滤镜动作。*/        __getset(0, __proto, "action", function() {
            return this._action;
        });
        Filter.BLUR = 16;
        Filter.COLOR = 32;
	...
	*/
    //class laya.maths.Arith
        ...
        Arith.setMatToArray = function(mat, array) {
            mat.a, mat.b, 0, 0, mat.c, mat.d, 0, 0, 0, 0, 1, 0, mat.tx + 20, mat.ty + 20, 0, 
            1;
            array[0] = mat.a;
            array[1] = mat.b;
            array[4] = mat.c;
	...
	*/
    //class laya.maths.Bezier
        ...
        /**@private */        __proto._switchPoint = function(x, y) {
	...
	*/
    //class laya.maths.GrahamScan
        ...
        GrahamScan.scan = function(PointSet) {
            ...
            for (i = 1; i < n; i++) if (PointSet[i].y < PointSet[k].y || PointSet[i].y == PointSet[k].y && PointSet[i].x < PointSet[k].x) k = i;
            tmp = PointSet[0];
            PointSet[0] = PointSet[k];
            PointSet[k] = tmp;
            for (i = 1; i < n - 1; i++) {
                k = i;
                for (j = i + 1; j < n; j++) if (GrahamScan.multiply(PointSet[j], PointSet[k], PointSet[0]) > 0 || GrahamScan.multiply(PointSet[j], PointSet[k], PointSet[0]) == 0 && GrahamScan.dis(PointSet[0], PointSet[j]) < GrahamScan.dis(PointSet[0], PointSet[k])) k = j;
                tmp = PointSet[i];
	...
	*/
    //class laya.maths.Rectangle
		...
		*/;
        ...
        /**此矩形底端的 Y 轴坐标。y 和 height 属性的和。*/        __getset(0, __proto, "bottom", function() {
	...
	*/
    //class laya.media.SoundManager
		...
		*/        __getset(1, SoundManager, "soundMuted", function() {
        ...
        SoundManager.playMusicSound = function(url, loops, complete, soundClass, startTime) {
            loops === void 0 && (loops = 1);
            startTime === void 0 && (startTime = 0);
            if (!SoundManager._isActive) return null;
            if (SoundManager._muted) return null;
        ...
        SoundManager.playMusic = function(url, loops, complete, startTime) {
            ...
            return SoundManager._musicChannel = SoundManager.playMusicSound(url, loops, complete, null, startTime);
        };
	...
	*/
    //class laya.net.ResourceVersion
        ...
        ResourceVersion.addVersionPrefix = function(originURL) {
            if (ResourceVersion.manifest && ResourceVersion.manifest[originURL]) return ResourceVersion.manifest[originURL] + "/" + originURL;
            return originURL;
        };
	...
	*/
    //class laya.net.URL
        ...
        /**地址的路径。*/        __getset(0, __proto, "path", function() {
            return this._path;
        });
        /**格式化后的地址。*/        __getset(0, __proto, "url", function() {
            return this._url;
        });
	...
	*/
    //class laya.renders.Render
        ...
        /**@private */        __proto._onVisibilitychange = function() {
            if (!Laya.stage.isVisibility) {
                this._timeId = Browser.window.setInterval(this._enterFrame, 1e3);
        ...
        /**渲染使用的原生画布引用。 */        __getset(1, Render, "canvas", function() {
        ...
        Render.__init$ = function() {
            ...
            /*__JS__ */            window.ConchRenderType |= !window.conch ? 0 : 4;
            {
                Render.isConchNode = /*__JS__ */ (window.ConchRenderType & 5) == 5;
                Render.isConchApp = /*__JS__ */ (window.ConchRenderType & 4) == 4;
	...
	*/
    //class laya.renders.RenderContext
        ...
        /**销毁当前渲染环境*/        __proto.destroy = function() {
            if (this.canvas) {
                this.canvas.destroy();
                this.canvas = null;
            }
    ...
    //class laya.renders.RenderSprite
        ...
        __proto._canvas = function(sprite, context, x, y) {
            ...
            if (_repaint) {
                ...
                if (tCacheType === "bitmap") canvas.context.asBitmap = true; else if (tCacheType === "normal") canvas.context.asBitmap = false;
                var t;
        ...
        RenderSprite.__init__ = function() {
            var i = 0, len = 0;
            var initRender;
            initRender = RunDriver.createRenderSprite(69905, null);
            len = RenderSprite.renders.length = 2048 * 2;
            ...
            _initSame([ 1, 512, 4, 2 ], new RenderSprite(1, null));
            RenderSprite.renders[1 | 512] = RunDriver.createRenderSprite(1 | 512, null);
            RenderSprite.renders[1 | 4 | 512] = new RenderSprite(1 | 4 | 512, null);
        };
        ...
        RenderSprite.IMAGE = 1;
        RenderSprite.ALPHA = 2;
        RenderSprite.TRANSFORM = 4;
        RenderSprite.BLEND = 8;
        RenderSprite.CANVAS = 16;
        RenderSprite.FILTERS = 32;
        RenderSprite.MASK = 64;
        RenderSprite.CLIP = 128;
        RenderSprite.STYLE = 256;
        RenderSprite.GRAPHICS = 512;
        RenderSprite.CUSTOM = 1024;
        RenderSprite.CHILDS = 2048;
        RenderSprite.INIT = 69905;
	...
	*/
    //class laya.resource.Context
        ...
        Context.newKeys = [];
        __static(Context, [ "replaceKeys", function() {
    ...
    //class laya.resource.ResourceManager
		...
		*/;
        __proto.addResource = function(resource) {
            if (resource.resourceManager) resource.resourceManager.removeResource(resource);
		...
		*/;
        __proto.setUniqueName = function(newName) {
            ...
            for (var i = 0; i < ResourceManager._resourceManagers.length; i++) {
                if (ResourceManager._resourceManagers[i]._name !== newName || ResourceManager._resourceManagers[i] === this) continue;
                isUnique = false;
                return;
            }
            if (isUnique) {
        ...
        __proto.dispose = function() {
            if (this === ResourceManager._systemResourceManager) throw new Error("systemResourceManager不能被释放！");
		...
		*/;
        __proto.addSize = function(add) {
            if (add) {
                if (this.autoRelease && add > 0) this._memorySize + add > this.autoReleaseMaxSize && this.garbageCollection((1 - this._garbageCollectionRate) * this.autoReleaseMaxSize);
		...
		*/;
        __proto.garbageCollection = function(reserveSize) {
            ...
            all.sort(function(a, b) {
                ...
                if (a.released && b.released) return 0; else if (a.released) return 1; else if (b.released) return -1;
		...
		*/        __getset(1, ResourceManager, "systemResourceManager", function() {
            ResourceManager._systemResourceManager === null && (ResourceManager._systemResourceManager = new ResourceManager(), 
            ResourceManager._systemResourceManager._name = "System Resource Manager");
		...
		*/        __getset(1, ResourceManager, "sortedResourceManagersByName", function() {
        ...
        ResourceManager.compareResourceManagersByName = function(left, right) {
            ...
            if (x == null) {
                ...
                if (y == null) return 1; else {
                    var retval = x.localeCompare(y);
                    if (retval != 0) return retval; else {
	...
	*/
    //class laya.utils.Browser
		...
		*/        __getset(1, Browser, "clientWidth", function() {
        ...
        /**浏览器原生 window 对象的引用。*/        __getset(1, Browser, "window", function() {
            Browser.__init__();
		...
		*/        __getset(1, Browser, "clientHeight", function() {
        ...
        /**浏览器窗口物理宽度。考虑了设备像素比。*/        __getset(1, Browser, "width", function() {
            Browser.__init__();
            return (Laya.stage && Laya.stage.canvasRotation ? Browser.clientHeight : Browser.clientWidth) * Browser.pixelRatio;
        });
        /**画布容器，用来盛放画布的容器。方便对画布进行控制*/        __getset(1, Browser, "container", function() {
            Browser.__init__();
        ...
        /**浏览器原生 document 对象的引用。*/        __getset(1, Browser, "document", function() {
            Browser.__init__();
        ...
        Browser.__init__ = function() {
            ...
            /*__JS__ */            window.requestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(c) {
            ...
            Browser.httpProtocol = /*[SAFE]*/ Browser.window.location.protocol == "https:";
            ...
            if (window.WXAPP == true) {
                var ua = wx.getSystemInfoSync();
                if (ua.system) {
                    Browser.onAndriod = /*[SAFE]*/ ua.system.indexOf("Android") > -1 || ua.system.indexOf("Adr") > -1;
                    Browser.onIOS = /*[SAFE]*/ ua.system.indexOf("iOS") > -1 || ua.system.indexOf("IOS") > -1;
                }
            }
        };
	...
	*/
    //class laya.utils.Byte
        ...
        /**@private */        __proto.___resizeBuffer = function(len) {
            try {
		...
		*/        __getset(0, __proto, "length", function() {
            ...
            if (this._allocated_ < value) this.___resizeBuffer(this._allocated_ = Math.floor(Math.max(value, this._allocated_ * 2))); else if (this._allocated_ > value) this.___resizeBuffer(this._allocated_ = value);
            this._length = value;
        });
        /**
	...
	*/
    //class laya.utils.ClassUtils
        ...
        ClassUtils.getInstance = function(className) {
            ...
            if (compClass) return new compClass(); else console.warn("[error] Undefined class:", className);
            return null;
        };
        ClassUtils.createByJson = function(json, node, root, customHandler, instanceHandler) {
            ...
            if (child) {
                for (var i = 0, n = child.length; i < n; i++) {
                    var data = child[i];
                    if ((data.props.name === "render" || data.props.renderType === "render") && node["_$set_itemRender"]) node.itemRender = data; else {
        ...
        ClassUtils._getTransformData = function(propsO) {
            ...
            if (sx != 1 || sy != 1 || rotate != 0) {
                m = m || new Matrix();
                m.scale(sx, sy);
                m.rotate(rotate * .0174532922222222);
            }
            return m;
        };
    ...
    //class laya.utils.Color
        ...
        function Color(str) {
            ...
            //this._drawStyle=null;
                ...
                if (flag) {
                    this._color = [ parseInt(str.substr(0, 2), 16) / 255, ((16711680 & color) >> 16) / 255, ((65280 & color) >> 8) / 255, (255 & color) / 255 ];
                    return;
                }
            } else {
            ...
            this._color = [ ((16711680 & color) >> 16) / 255, ((65280 & color) >> 8) / 255, (255 & color) / 255, 1 ];
        ...
        Color.create = function(str) {
            ...
            Color._SAVE_SIZE < 1e3 || Color._initSaveMap();
    ...
    //class laya.utils.Dragging
		...
		*/;
        __proto.checkElastic = function() {
            var tx = NaN;
            var ty = NaN;
            if (this.target.x < this.area.x) tx = this.area.x; else if (this.target.x > this.area.x + this.area.width) tx = this.area.x + this.area.width;
            if (this.target.y < this.area.y) ty = this.area.y; else if (this.target.y > this.area.y + this.area.height) ty = this.area.y + this.area.height;
		...
		*/;
        __proto.tweenMove = function() {
            ...
            if (Math.abs(this._offsetX) < 1 && Math.abs(this._offsetY) < 1 || this._elasticRateX < .5 || this._elasticRateY < .5) {
                Laya.timer.clear(this, this.tweenMove);
                if (this.elasticDistance > 0) this.checkElastic(); else this.clear();
            }
        }
        /**
		*结束拖拽。
	...
	*/
    //class laya.utils.Ease
        ...
        Ease.bounceInOut = function(t, b, c, d) {
            if (t < d * .5) return Ease.bounceIn(t * 2, 0, c, d) * .5 + b; else return Ease.bounceOut(t * 2 - d, 0, c, d) * .5 + c * .5 + b;
        };
        ...
        Ease.backInOut = function(t, b, c, d, s) {
            s === void 0 && (s = 1.70158);
            if ((t /= d * .5) < 1) return c * .5 * (t * t * (((s *= 1.525) + 1) * t - s)) + b;
        ...
        Ease.expoInOut = function(t, b, c, d) {
            if (t == 0) return b;
            if (t == d) return b + c;
            if ((t /= d * .5) < 1) return c * .5 * Math.pow(2, 10 * (t - 1)) + b;
        ...
        Ease.circInOut = function(t, b, c, d) {
            if ((t /= d * .5) < 1) return -c * .5 * (Math.sqrt(1 - t * t) - 1) + b;
            return c * .5 * (Math.sqrt(1 - (t -= 2) * t) + 1) + b;
        };
        Ease.circOut = function(t, b, c, d) {
            return c * Math.sqrt(1 - (t = t / d - 1) * t) + b;
        };
        Ease.HALF_PI = Math.PI * .5;
        Ease.PI2 = Math.PI * 2;
        return Ease;
    }();
    /**
	...
	*/
    //class laya.utils.HitArea
		...
		*/        __getset(0, __proto, "unHit", function() {
        ...
        HitArea._cmds = [];
        __static(HitArea, [ "_rec", function() {
	...
	*/
    //class laya.utils.Mouse
		...
		*/        __getset(1, Mouse, "cursor", function() {
        ...
        __static(Mouse, [ "_style", function() {
    ...
    //class laya.utils.Stat
		...
		*/        __getset(1, Stat, "onclick", null, function(fn) {
        ...
        Stat.loop = function() {
            ...
            if (timer - Stat._timer < 1e3) return;
            var count = Stat._count;
            Stat.FPS = Math.round(count * 1e3 / (timer - Stat._timer));
            if (Stat._canvas) {
		...
		*/        __proto._update = function() {
        ...
        __proto._clearHandlers = function() {
            ...
            for (var i = 0, n = handlers.length; i < n; i++) {
                ...
                if (handler.method !== null) this._temp.push(handler); else this._recoverHandler(handler);
            }
        ...
        __proto._indexHandler = function(handler) {
            ...
            var mid = method.$_TID || (method.$_TID = this._mid++ * 1e5);
            handler.key = cid + mid;
		...
		*/;
        __proto.callLater = function(caller, method, args) {
            if (this._getHandler(caller, method) == null) {
                if (Timer._pool.length) var handler = Timer._pool.pop(); else handler = new TimerHandler();
                handler.caller = caller;
                handler.method = method;
                handler.args = args;
                this._indexHandler(handler);
    ...
    //class laya.utils.Tween
		...
		*/;
        ...
        __proto._create = function(target, props, duration, ease, complete, delay, coverBefore, isTo, usePool, runNow) {
            ...
            if (runNow) {
                if (delay <= 0) this.firstStart(target, props, isTo); else Laya.timer.once(delay, this, this.firstStart, [ target, props, isTo ]);
            } else {
    ...
    //class laya.utils.Utils
        ...
        Utils.updateOrder = function(array) {
            ...
            while (i < len) {
                ...
                key = array[j]._zOrder;
                while (--j > -1) {
                    if (array[j]._zOrder > key) array[j + 1] = array[j]; else break;
                }
                array[j + 1] = c;
                i++;
            }
	...
	*/
    //class laya.display.Node extends laya.events.EventDispatcher
        ...
        /**@private */        __proto._setBit = function(type, value) {
            if (type == 1) {
		...
		*/;
        __proto.destroy = function(destroyChild) {
            ...
            if (this._childs) {
                if (destroyChild) this.destroyChildren(); else this.removeChildren();
            }
            this._childs = null;
            this._$P = null;
            this.offAll();
		...
		*/;
        ...
        __proto._setDisplay = function(value) {
            if (this._displayedInStage !== value) {
                ...
                if (value) this.event(/*laya.events.Event.DISPLAY*/ "display"); else this.event(/*laya.events.Event.UNDISPLAY*/ "undisplay");
            }
        }
        /**
		*@private
		...
		*/;
        ...
        /**父节点。*/        __getset(0, __proto, "parent", function() {
            return this._parent;
        }, function(value) {
        ...
        /**表示是否在显示列表中显示。*/        __getset(0, __proto, "displayedInStage", function() {
	...
	*/
    //class laya.display.css.CSSStyle extends laya.display.css.Style
        ...
        /**@inheritDoc */        __proto.destroy = function() {
            this._ower = null;
            this._font = null;
            this._rect = null;
        }
		...
		*/;
        __proto._calculation = function(type, value) {
            ...
            if (rect === null) {
                parent._getCSSStyle()._type |= 524288;
            ...
            if (nums.length == 1) nums[1] = nums[2] = 0; else {
		...
		*/;
        __proto.size = function(w, h) {
            ...
            if (resize) {
                ower._layoutLater();
                this._type & 524288 && ower.event(/*laya.events.Event.RESIZE*/ "resize", this);
            }
        }
        /**@private */;
        ...
        __proto._createFont = function() {
            return this._type & 4096 ? this._font : (this._type |= 4096, this._font = new Font(this._font));
        }
        /**@inheritDoc */;
        __proto.render = function(sprite, context, x, y) {
            var w = sprite.width;
		...
		*/;
        __getset(0, __proto, "block", _super.prototype._$get_block, function(value) {
            value ? this._type |= 1 : this._type &= ~1;
        });
        /**
		*垂直对齐方式。
		...
		*/        __getset(0, __proto, "left", null, function(value) {
            ...
            if (typeof value == "string") {
                if (value === "center") value = "50% -50% 0"; else if (value === "right") value = "100% -100% 0";
        ...
        /**@inheritDoc */        __getset(0, __proto, "absolute", function() {
		...
		*/        __getset(0, __proto, "top", null, function(value) {
            var ower = this._ower;
            if (typeof value == "string") {
                if (value === "middle") value = "50% -50% 0"; else if (value === "bottom") value = "100% -100% 0";
		...
		*/        __getset(0, __proto, "lineElement", function() {
            ...
            value ? this._type |= 65536 : this._type &= ~65536;
        });
        /**
		*浮动方向。
		*/        __getset(0, __proto, "cssFloat", function() {
            ...
            value === "right" ? this._type |= 32768 : this._type &= ~32768;
        });
        /**
		*添加到文本的修饰。
		...
		*/        __getset(0, __proto, "whiteSpace", function() {
            ...
            type === "nowrap" && (this._type |= 131072);
            type === "none" && (this._type &= ~131072);
        });
        __getset(0, __proto, "background", null, function(value) {
            ...
            this._type |= 16384;
            this._ower._renderType |= /*laya.renders.RenderSprite.STYLE*/ 256;
        });
        /**
		*表示是否换行。
		*/        __getset(0, __proto, "wordWrap", function() {
            ...
            value ? this._type &= ~131072 : this._type |= 131072;
        });
        /**
		*字体颜色。
		*/        __getset(0, __proto, "color", function() {
		...
		*/        __getset(0, __proto, "backgroundColor", function() {
            ...
            if (value === "none") this._bgground = null; else this._bgground || (this._bgground = {}), 
            this._bgground.color = value;
            this._ower.conchModel && this._ower.conchModel.bgColor(value);
            this._ower._renderType |= /*laya.renders.RenderSprite.STYLE*/ 256;
        });
		...
		*/        __getset(0, __proto, "position", function() {
            ...
            value == "absolute" ? this._type |= 4 : this._type &= ~4;
        });
        /**
		*规定元素应该生成的框的类型。
		*/        __getset(0, __proto, "display", null, function(value) {
        ...
        /**@inheritDoc */        __getset(0, __proto, "paddingLeft", function() {
            return this.padding[3];
        });
        /**@inheritDoc */        __getset(0, __proto, "paddingTop", function() {
        ...
        CSSStyle._CSS_BLOCK = 1;
        CSSStyle._DISPLAY_NONE = 2;
        CSSStyle._ABSOLUTE = 4;
        CSSStyle._WIDTH_SET = 8;
        CSSStyle._PADDING = [ 0, 0, 0, 0 ];
        CSSStyle._RECT = [ -1, -1, -1, -1 ];
        CSSStyle._SPACING = [ 0, 0 ];
        CSSStyle._ALIGNS = [ 0, 0, 0 ];
        CSSStyle.ADDLAYOUTED = 512;
        CSSStyle._NEWFONT = 4096;
        CSSStyle._HEIGHT_SET = 8192;
        CSSStyle._BACKGROUND_SET = 16384;
        CSSStyle._FLOAT_RIGHT = 32768;
        CSSStyle._LINE_ELEMENT = 65536;
        CSSStyle._NOWARP = 131072;
        CSSStyle._WIDTHAUTO = 262144;
        CSSStyle._LISTERRESZIE = 524288;
        return CSSStyle;
    }(Style);
    /**
	*@private
    ...
    //class laya.media.h5audio.AudioSound extends laya.events.EventDispatcher
		...
		*/;
        ...
        __proto.load = function(url) {
            url = window.replacePath(url, Laya.URL.basePath);
            url = URL.formatURL(url);
            this.url = url;
            ...
            if (!ad) {
                if (adList.length >= 4) {
                    delete AudioSound._audioCache[adList[0].src];
                    ad = adList[0];
                    adList.splice(0, 1);
                    adList.push(ad);
                } else {
        ...
        var musicAd;
        __proto.loadMusic = function(url) {
            url = window.replacePath(url, Laya.URL.basePath);
            url = URL.formatURL(url);
            this.url = url;
            var ad = AudioSound._audioCache[url];
	...
	*/
    //class laya.media.webaudio.WebAudioSound extends laya.events.EventDispatcher
		...
		*/;
        ...
        __static(WebAudioSound, [ "window", function() {
            ...
            return this.ctx = WebAudioSound.webAudioEnabled ? new (WebAudioSound.window["AudioContext"] || WebAudioSound.window["webkitAudioContext"] || WebAudioSound.window["mozAudioContext"])() : undefined;
    ...
    //class laya.net.HttpRequest extends laya.events.EventDispatcher
		...
		*/        __proto.send = function(url, data, method, responseType, headers) {
            ...
            if (headers) {
                ...
                if (!data || typeof data == "string") http.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"); else http.setRequestHeader("Content-Type", "application/json");
            }
		...
		*/        __getset(0, __proto, "http", function() {
        ...
        /**返回的数据。*/        __getset(0, __proto, "data", function() {
            return this._data;
        });
        return HttpRequest;
    }(EventDispatcher);
	...
	*/
    //class laya.net.Loader extends laya.events.EventDispatcher
		...
		*/        __proto.load = function(url, type, cache, group, ignoreCache) {
            ...
            this._url = url;
            if (url.indexOf("data:image") === 0) type = "image"; else url = URL.formatURL(url);
		...
		*/;
        ...
        __proto.onProgress = function(value) {
            if (this._type === "atlas") this.event(/*laya.events.Event.PROGRESS*/ "progress", value * .3); else this.event(/*laya.events.Event.PROGRESS*/ "progress", value);
        }
        /**@private */;
        ...
        __proto.onLoaded = function(data) {
            ...
            if (type === "image") {
                ...
                if (!data.src && !data._setContext) {
                    if (!this._data) {
                        ...
                        if (data.meta && data.meta.image) {
                            ...
                            for (var i = 0, len = toloadPics.length; i < len; i++) {
                                ...
                                toloadPics[i] = window.fixAtlasPic(toloadPics[i]);
                            }
                        } else {
                    ...
                    this.event(/*laya.events.Event.PROGRESS*/ "progress", .3 + 1 / toloadPics.length * .6);
                    return this._loadImage(toloadPics.pop());
                } else {
                    this._data.pics.push(data);
                    if (this._data.toLoads.length > 0) {
                        this.event(/*laya.events.Event.PROGRESS*/ "progress", .3 + 1 / this._data.toLoads.length * .6);
                ...
                if (!data.src) {
                    this._data = data;
                    this.event(/*laya.events.Event.PROGRESS*/ "progress", .5);
		...
		*/;
        ...
        /**是否缓存。*/        __getset(0, __proto, "cache", function() {
            return this._cache;
        });
        /**加载类型。*/        __getset(0, __proto, "type", function() {
            return this._type;
        });
        ...
        Loader.getRes = function(url) {
            var sub_url = URL.formatURL(url);
            var absolute_url = window.replacePath(sub_url);
            return Loader.loadedMap[sub_url] || Loader.loadedMap[absolute_url];
        };
        Loader.getAtlas = function(url) {
            var sub_url = URL.formatURL(url);
            var absolute_url = window.replacePath(sub_url);
            return Loader.atlasMap[sub_url] || Loader.atlasMap[absolute_url];
        };
	...
	*/
    //class laya.filters.ColorFilter extends laya.filters.Filter
        ...
        function ColorFilter(mat) {
            ...
            if (!mat) {
                mat = [ .3, .59, .11, 0, 0, .3, .59, .11, 0, 0, .3, .59, .11, 0, 0, 0, 0, 0, 1, 0 ];
            }
		...
		*/;
        ...
        /**@private */        __getset(0, __proto, "action", function() {
            return this._action;
        });
        return ColorFilter;
    }(Filter);
	...
	*/
    //class laya.resource.Resource extends laya.events.EventDispatcher
		...
		*/;
        __proto.setUniqueName = function(newName) {
            ...
            for (var i = 0; i < Resource._loadedResources.length; i++) {
                if (Resource._loadedResources[i]._name !== newName || Resource._loadedResources[i] === this) continue;
                isUnique = false;
                return;
            }
            if (isUnique) {
		...
		*/;
        __proto.dispose = function() {
            if (this._resourceManager !== null) throw new Error("附属于resourceManager的资源不能独立释放！");
            this._disposed = true;
            this.lock = false;
	...
	*/
    //class laya.resource.Texture extends laya.events.EventDispatcher
		...
		*/        __proto.setTo = function(bitmap, uv) {
            ...
            if (bitmap) {
                ...
                if (this._loaded) {
                    ...
                    var bm = bitmap;
                    if (bm instanceof laya.resource.HTMLImage && bm.image) bm.image.addEventListener("load", function(e) {
                        RunDriver.addToAtlas && RunDriver.addToAtlas(_this);
                    }, false);
                }
            }
		...
		*/        __getset(0, __proto, "released", function() {
        ...
        /**实际宽度。*/        __getset(0, __proto, "width", function() {
		...
		*/        __getset(0, __proto, "repeat", function() {
        ...
        /**实际高度。*/        __getset(0, __proto, "height", function() {
		...
		*/        __getset(0, __proto, "isLinearSampling", function() {
            return Render.isWebGL ? this.bitmap.minFifter != 9728 : true;
        }, function(value) {
        ...
        Texture.createFromTexture = function(texture, x, y, width, height) {
            ...
            if (result) var tex = Texture.create(texture, result.x, result.y, result.width, result.height, result.x - rect.x, result.y - rect.y, width, height); else return null;
            tex.bitmap.useNum--;
            return tex;
        };
        Texture.DEF_UV = [ 0, 0, 1, 0, 1, 1, 0, 1 ];
        Texture.INV_UV = [ 0, 1, 1, 1, 1, 0, 0, 0 ];
    ...
    //class laya.display.Sprite extends laya.display.Node
		...
		*/;
        ...
        __proto._adjustTransform = function() {
            ...
            if (tf.rotate || sx !== 1 || sy !== 1 || tf.skewX || tf.skewY) {
                ...
                m.bTransform = true;
                var skx = (tf.rotate - tf.skewX) * .0174532922222222;
                var sky = (tf.rotate + tf.skewY) * .0174532922222222;
                var cx = Math.cos(sky);
                ...
                this._transform = null;
                this._renderType &= ~/*laya.renders.RenderSprite.TRANSFORM*/ 4;
            }
            return m;
        }
        /**
		...
		*/;
        __proto.customRender = function(context, x, y) {
            this._renderType |= /*laya.renders.RenderSprite.CUSTOM*/ 1024;
        }
        /**
		*@private
		*应用滤镜。
        ...
        __proto._isHaveGlowFilter = function() {
            ...
            if (this.filters) {
                for (i = 0; i < this.filters.length; i++) {
                    if (this.filters[i].type == /*laya.filters.Filter.GLOW*/ 8) {
                        return true;
                    }
                }
            }
		...
		*/;
        __proto.on = function(type, caller, listener, args) {
            if (this._mouseEnableState !== 1 && this.isMouseEvent(type)) {
                ...
                this._setBit(/*laya.display.Node.MOUSEENABLE*/ 2, true);
                if (this._parent) {
                    this._$2__onDisplay();
                }
                return this._createListener(type, caller, listener, args, false);
        ...
        __proto._$2__onDisplay = function() {
            if (this._mouseEnableState !== 1) {
                ...
                while (ele && ele._mouseEnableState !== 1) {
                    if (ele._getBit(/*laya.display.Node.MOUSEENABLE*/ 2)) break;
                    ele.mouseEnabled = true;
                    ele._setBit(/*laya.display.Node.MOUSEENABLE*/ 2, true);
                    ele = ele.parent;
                }
            }
        }
		...
		*/;
        ...
        /**@private */;
        __proto._childChanged = function(child) {
            if (this._childs.length) this._renderType |= /*laya.renders.RenderSprite.CHILDS*/ 2048; else this._renderType &= ~/*laya.renders.RenderSprite.CHILDS*/ 2048;
		...
		*/        __getset(0, __proto, "cacheAs", function() {
            ...
            if (value !== "none") {
                if (!this._getBit(/*laya.display.Node.NOTICE_DISPLAY*/ 1)) this._setUpNoticeType(/*laya.display.Node.NOTICE_DISPLAY*/ 1);
                cacheCanvas || (cacheCanvas = this._set$P("cacheCanvas", Pool.getItemByClass("cacheCanvas", Object)));
                cacheCanvas.type = value;
                cacheCanvas.reCache = true;
                this._renderType |= /*laya.renders.RenderSprite.CANVAS*/ 16;
        ...
        /**z排序，更改此值，则会按照值的大小对同一容器的所有对象重新排序。值越大，越靠上。默认为0，则根据添加顺序排序。*/        __getset(0, __proto, "zOrder", function() {
            return this._zOrder;
        }, function(value) {
        ...
        /**旋转角度，默认值为0。以角度为单位。*/        __getset(0, __proto, "rotation", function() {
		...
		*/        __getset(0, __proto, "width", function() {
        ...
        /**表示显示对象相对于父容器的水平方向坐标值。*/        __getset(0, __proto, "x", function() {
            return this._x;
        }, function(value) {
            if (this._x !== value) {
		...
		*/        __getset(0, __proto, "hitArea", function() {
        ...
        /**设置cacheAs为非空时此值才有效，staticCache=true时，子对象变化时不会自动更新缓存，只能通过调用reCache方法手动刷新。*/        __getset(0, __proto, "staticCache", function() {
            return this._$P.staticCache;
        }, function(value) {
            this._set$P("staticCache", value);
            if (!value) this.reCache();
        });
        /**设置一个Texture实例，并显示此图片（如果之前有其他绘制，则会被清除掉）。等同于graphics.clear();graphics.drawTexture()*/        __getset(0, __proto, "texture", function() {
        ...
        /**表示显示对象相对于父容器的垂直方向坐标值。*/        __getset(0, __proto, "y", function() {
            return this._y;
        }, function(value) {
            if (this._y !== value) {
                if (this.destroyed) return;
		...
		*/        __getset(0, __proto, "height", function() {
        ...
        /**指定要使用的混合模式。目前只支持"lighter"。*/        __getset(0, __proto, "blendMode", function() {
            return this._style.blendMode;
        }, function(value) {
            this.getStyle().blendMode = value;
            this.conchModel && this.conchModel.blendMode(value);
            if (value && value != "source-over") this._renderType |= /*laya.renders.RenderSprite.BLEND*/ 8; else this._renderType &= ~/*laya.renders.RenderSprite.BLEND*/ 8;
            this.parentRepaint();
        });
        /**X轴缩放值，默认值为1。设置为负数，可以实现水平反转效果，比如scaleX=-1。*/        __getset(0, __proto, "scaleX", function() {
        ...
        /**Y轴缩放值，默认值为1。设置为负数，可以实现垂直反转效果，比如scaleX=-1。*/        __getset(0, __proto, "scaleY", function() {
        ...
        /**对舞台 <code>stage</code> 的引用。*/        __getset(0, __proto, "stage", function() {
            return Laya.stage;
        });
        /**水平倾斜角度，默认值为0。以角度为单位。*/        __getset(0, __proto, "skewX", function() {
		...
		*/        __getset(0, __proto, "scrollRect", function() {
            ...
            this.repaint();
            if (value) {
                this._renderType |= /*laya.renders.RenderSprite.CLIP*/ 128;
                this.conchModel && this.conchModel.scrollRect(value.x, value.y, value.width, value.height);
            } else {
                this._renderType &= ~/*laya.renders.RenderSprite.CLIP*/ 128;
                if (this.conchModel) {
                    if (Sprite.RUNTIMEVERION < "0.9.1") this.conchModel.removeType(64); else this.conchModel.removeType(/*laya.renders.RenderSprite.CLIP*/ 128);
                }
            }
        });
        /**垂直倾斜角度，默认值为0。以角度为单位。*/        __getset(0, __proto, "skewY", function() {
		...
		*/        __getset(0, __proto, "transform", function() {
            ...
            if (value) this._renderType |= /*laya.renders.RenderSprite.TRANSFORM*/ 4; else {
                this._renderType &= ~/*laya.renders.RenderSprite.TRANSFORM*/ 4;
                this.conchModel && this.conchModel.removeType(/*laya.renders.RenderSprite.TRANSFORM*/ 4);
            }
            this.parentRepaint();
        });
        /**X轴 轴心点的位置，单位为像素，默认为0。轴心点会影响对象位置，缩放中心，旋转中心。*/        __getset(0, __proto, "pivotX", function() {
        ...
        /**Y轴 轴心点的位置，单位为像素，默认为0。轴心点会影响对象位置，缩放中心，旋转中心。*/        __getset(0, __proto, "pivotY", function() {
        ...
        /**透明度，值为0-1，默认值为1，表示不透明。更改alpha值会影响drawcall。*/        __getset(0, __proto, "alpha", function() {
            ...
            if (this._style && this._style.alpha !== value) {
                ...
                if (value !== 1) this._renderType |= /*laya.renders.RenderSprite.ALPHA*/ 2; else this._renderType &= ~/*laya.renders.RenderSprite.ALPHA*/ 2;
                this.parentRepaint();
            }
        });
        /**表示是否可见，默认为true。如果设置不可见，节点将不被渲染。*/        __getset(0, __proto, "visible", function() {
        ...
        /**绘图对象。封装了绘制位图和矢量图的接口，Sprite所有的绘图操作都通过Graphics来实现的。*/        __getset(0, __proto, "graphics", function() {
            return this._graphics || (this.graphics = RunDriver.createGraphics());
        }, function(value) {
            if (this._graphics) this._graphics._sp = null;
            this._graphics = value;
            if (value) {
                this._renderType &= ~/*laya.renders.RenderSprite.IMAGE*/ 1;
                this._renderType |= /*laya.renders.RenderSprite.GRAPHICS*/ 512;
                value._sp = this;
                ...
                this._renderType &= ~/*laya.renders.RenderSprite.IMAGE*/ 1;
                if (this.conchModel) {
                    if (Sprite.RUNTIMEVERION < "0.9.1") this.conchModel.removeType(256); else this.conchModel.removeType(/*laya.renders.RenderSprite.GRAPHICS*/ 512);
                }
            }
            this.repaint();
        });
        /**滤镜集合。可以设置多个滤镜组合。*/        __getset(0, __proto, "filters", function() {
            ...
            if (Render.isConchApp) {
                if (this.conchModel) {
                    if (Sprite.RUNTIMEVERION < "0.9.1") this.conchModel.removeType(16); else this.conchModel.removeType(/*laya.renders.RenderSprite.FILTERS*/ 32);
                }
            ...
            if (Render.isWebGL) {
                if (value && value.length) {
                    this._renderType |= /*laya.renders.RenderSprite.FILTERS*/ 32;
                } else {
                    this._renderType &= ~/*laya.renders.RenderSprite.FILTERS*/ 32;
                }
            }
        ...
        __getset(0, __proto, "parent", _super.prototype._$get_parent, function(value) {
            ...
            if (value && this._getBit(/*laya.display.Node.MOUSEENABLE*/ 2)) {
                this._$2__onDisplay();
            }
        });
        /**
		...
		*/        __getset(0, __proto, "mask", function() {
            ...
            this._renderType |= /*laya.renders.RenderSprite.MASK*/ 64;
            this.parentRepaint();
        });
        /**
		*是否接受鼠标事件。
		...
		*/        __getset(0, __proto, "mouseY", function() {
        ...
        __static(Sprite, [ "RUNTIMEVERION", function() {
            return this.RUNTIMEVERION = /*__JS__ */ window.conch ? conchConfig.getRuntimeVersion().substr(conchConfig.getRuntimeVersion().lastIndexOf("-") + 1) : "";
        } ]);
        return Sprite;
    }(Node);
    /**
    ...
    //class laya.media.h5audio.AudioSoundChannel extends laya.media.SoundChannel
		...
		*/;
        __proto.stop = function() {
            ...
            if ("pause" in this._audio) if (Render.isConchApp) {
                this._audio.stop();
            }
            this._audio.pause();
	...
	*/
    //class laya.media.webaudio.WebAudioSoundChannel extends laya.media.SoundChannel
		...
		*/;
        __getset(0, __proto, "position", function() {
            if (this.bufferSource) {
                return (Browser.now() - this._startTime) / 1e3 + this.startTime;
            }
            return 0;
        });
        __getset(0, __proto, "duration", function() {
	...
	*/
    //class laya.display.AnimationPlayerBase extends laya.display.Sprite
        ...
        function AnimationPlayerBase() {
            ...
            this._setUpNoticeType(/*laya.display.Node.NOTICE_DISPLAY*/ 1);
        }
		...
		*/        __proto.play = function(start, loop, name) {
        ...
        __proto._checkResumePlaying = function() {
            if (this._isPlaying) {
                if (this._controlNode.displayedInStage) this.play(this._index, this.loop, this._actionName); else this.clearTimer(this, this._frameLoop);
            }
        }
        /**
		*停止动画播放。
	...
	*/
    //class laya.display.Text extends laya.display.Sprite
        ...
        /**@inheritDoc */        __proto.destroy = function(destroyChild) {
            destroyChild === void 0 && (destroyChild = true);
            _super.prototype.destroy.call(this, destroyChild);
            this._lines = null;
            if (this._words) {
        ...
        __proto.renderText = function(begin, visibleLineCount) {
            ...
            if (!tCurrBitmapFont && this._width > 0 && this._textWidth <= this._width) {
                if (this.align == "right") {
                    ...
                    textAlgin = "center";
                    startX = this._width * .5 + padding[3] - padding[1];
                }
            }
            if (this._height > 0) {
                var tempVAlign = this._textHeight > this._height ? "top" : this.valign;
                if (tempVAlign === "middle") startY = (this._height - visibleLineCount * lineHeight) * .5 + padding[0] - padding[2]; else if (tempVAlign === "bottom") startY = this._height - visibleLineCount * lineHeight - padding[2];
            }
            var style = this._style;
		...
		*/;
        __proto.typeset = function() {
            ...
            this.evalTextSize();
            if (this.checkEnabledViewportOrNot()) this._clipPoint || (this._clipPoint = new Point(0, 0)); else this._clipPoint = null;
        ...
        __proto.evalTextSize = function() {
            ...
            if (this._currBitmapFont) nh = this._lines.length * (this._currBitmapFont.getMaxHeight() + this.leading) + this.padding[0] + this.padding[2]; else nh = this._lines.length * (this._charSize.height + this.leading) + this.padding[0] + this.padding[2];
		...
		*/;
        __proto.parseLines = function(text) {
            ...
            for (var i = 0, n = lines.length; i < n; i++) {
                var line = lines[i];
                if (needWordWrapOrTruncate) this.parseLine(line, wordWrapWidth); else {
		...
		*/;
                    ...
                    if (this.wordWrap) {
                        ...
                        if (newLine.charCodeAt(newLine.length - 1) < 255) {
                            ...
                            if (execResult) {
                                ...
                                if (execResult.index == 0) j += newLine.length; else newLine = line.substring(startIndex, j);
                            }
                        }
                        lines.push(newLine);
        ...
        __proto.getTextWidth = function(text) {
            if (this._currBitmapFont) return this._currBitmapFont.getTextWidth(text); else return Browser.context.measureText(text).width;
        }
        /**
		*获取换行所需的宽度。
		*/;
        __proto.getWordWrapWidth = function() {
            var p = this.padding;
            var w = NaN;
            if (this._currBitmapFont && this._currBitmapFont.autoScaleSize) w = this._width * (this._currBitmapFont.fontSize / this.fontSize); else w = this._width;
            if (w <= 0) {
		...
		*/        __getset(0, __proto, "bold", function() {
        ...
        /**当前文本的内容字符串。*/        __getset(0, __proto, "text", function() {
            return this._text || "";
        }, function(value) {
            if (this._text !== value) {
                this.lang(value + "");
		...
		*/        __getset(0, __proto, "font", function() {
            ...
            if (Text._bitmapFonts && Text._bitmapFonts[value]) {
                ...
                if (Browser.onIPhone && Text._fontFamilyMapList.indexOf(value) > -1) {
                    ...
                    if (language == "zh-cn") this._fontActallyUsed += "-简"; else if (language == "zh-tw") this._fontActallyUsed += "-繁";
                }
            }
		...
		*/        __getset(0, __proto, "maxScrollY", function() {
        ...
        Text.supportFont = function(font) {
            ...
            if (arialFontWidth == customFontWidth) return false; else return true;
        };
        Text._testWord = "游";
        Text.langPacks = null;
        ...
        __static(Text, [ "_fontFamilyMapList", function() {
    ...
    //class laya.display.Stage extends laya.display.Sprite
        ...
        function Stage() {
            ...
            window.addEventListener("resize", function() {
                ...
                if (Browser.onSafari) _this._safariOffsetY = (Browser.window.__innerHeight || Browser.document.body.clientHeight || Browser.document.documentElement.clientHeight) - Browser.window.innerHeight;
                _this._resetCanvas();
            });
		...
		*/;
        __proto.setScreenSize = function(screenWidth, screenHeight) {
            ...
            canvas.size(canvasWidth + (screenWidth - realWidth), canvasHeight + (screenHeight - realHeight));
            RunDriver.changeWebGLSize(canvasWidth + (screenWidth - realWidth), canvasHeight + (screenHeight - realHeight));
            mat.scale(realWidth / canvasWidth / pixelRatio, realHeight / canvasHeight / pixelRatio);
            if (this._alignH === "left") this.offset.x = 0; else if (this._alignH === "right") this.offset.x = screenWidth - realWidth; else this.offset.x = (screenWidth - realWidth) * .5 / pixelRatio;
            if (this._alignV === "top") this.offset.y = 0; else if (this._alignV === "bottom") this.offset.y = screenHeight - realHeight; else this.offset.y = (screenHeight - realHeight) * .5 / pixelRatio;
            ...
            Laya.stage.x = (screenWidth - realWidth) * .5;
            Laya.stage.y = (screenHeight - realHeight) * .5;
            this["screenWidth"] = screenWidth;
            this["screenHeight"] = screenHeight;
            this["screenScaleX"] = scaleX;
            this["screenScaleY"] = scaleY;
            // if (hf.LayerMgr && hf.LayerMgr.container)
            // {
            //   hf.LayerMgr.container.x = (screenWidth - realWidth) * 0.5;
            //   hf.LayerMgr.container.y = (screenHeight - realHeight) * 0.5;
            //   console.log("screenWidth:" + screenWidth + " realWidth:" + realWidth + " container.x" + hf.LayerMgr.container.x);
            // }
                        if (this._safariOffsetY) mat.translate(0, -this._safariOffsetY);
        ...
        __proto._formatData = function(value) {
            ...
            if (Math.abs(1 - value) < .001) return value > 0 ? 1 : -1;
            return value;
        }
        /**@inheritDoc */;
        __proto.getMousePoint = function() {
		...
		*/;
        ...
        __proto.render = function(context, x, y) {
            if (this.frameRate === "sleep") {
                var now = Browser.now();
                if (now - this._frameStartTime >= 1e3) this._frameStartTime = now; else return;
            }
            this._renderCount++;
            ...
            var frameMode = this.frameRate === "mouse" ? this._frameStartTime - this._mouseMoveTime < 2e3 ? "fast" : "slow" : this.frameRate;
		...
		*/        __getset(0, __proto, "isVisibility", function() {
        ...
        /**当前视窗由缩放模式导致的 X 轴缩放系数。*/        __getset(0, __proto, "clientScaleX", function() {
		...
		*/        __getset(0, __proto, "alignV", function() {
        ...
        /**舞台的背景颜色，默认为黑色，null为透明。*/        __getset(0, __proto, "bgColor", function() {
        ...
        /**鼠标在 Stage 上的 X 轴坐标。*/        __getset(0, __proto, "mouseX", function() {
            return Math.round(MouseManager.instance.mouseX / this.clientScaleX - this.x / this["screenScaleX"]);
        });
        /**鼠标在 Stage 上的 Y 轴坐标。*/        __getset(0, __proto, "mouseY", function() {
            return Math.round(MouseManager.instance.mouseY / this.clientScaleY - this.y / this["screenScaleY"]);
        });
        /**
		*<p>场景布局类型。</p>
		*<p><ul>取值范围：
	...
	*/
    //class laya.media.SoundNode extends laya.display.Sprite
        ...
        /**@private */        __proto._onParentChange = function() {
    ...
    //class laya.display.Animation extends laya.display.AnimationPlayerBase
		...
		*/;
        __proto.loadAtlas = function(url, loaded, cacheName) {
            ...
            if (!_this._setFramesFromCache(cacheName)) {
                ...
                if (Loader.getAtlas(url)) onLoaded(url); else Laya.loader.load(url, Handler.create(null, onLoaded, [ url ]), null, /*laya.net.Loader.ATLAS*/ "atlas");
            }
            return this;
        }
        /**
		...
		*/;
        ...
        __proto._loadAnimationData = function(url, loaded, atlas) {
            ...
            if (Loader.getRes(url)) onLoaded(url); else Laya.loader.load(url, Handler.create(null, onLoaded, [ url ]), null, /*laya.net.Loader.JSON*/ "json");
            Loader.clearRes(url);
        }
        /**@private */;
		...
		*/;
        __getset(0, __proto, "frames", function() {
            ...
            if (value) {
                ...
                if (this._isPlaying) this.play(this._index, this.loop, this._actionName); else this.index = this._index;
            }
        });
        /**
		*是否自动播放，默认为false。如果设置为true，则动画被创建并添加到舞台后自动播放。
		*/        __getset(0, __proto, "autoPlay", null, function(value) {
            if (value) this.play(); else this.stop();
        });
        /**
		*<p>动画数据源。</p>
		*<p>类型如下：<br/>
		...
		*/        __getset(0, __proto, "source", null, function(value) {
            if (value.indexOf(".ani") > -1) this.loadAnimation(value); else if (value.indexOf(".json") > -1 || value.indexOf("als") > -1 || value.indexOf("atlas") > -1) this.loadAtlas(value); else this.loadImages(value.split(","));
        });
        /**
	...
	*/
    //class laya.display.FrameAnimation extends laya.display.AnimationPlayerBase
		...
		*/        __proto._setUp = function(targetDic, animationData) {
            ...
            this.interval = 1e3 / animationData.frameRate;
		...
		*/;
        __proto._calculateNodePropFrames = function(keyframes, frames, key, target) {
            ...
            if (len == 0) {
                ...
                if (this._animationNewFrames) this._animationNewFrames[keyframes[0].index] = true;
            }
            this._dealKeyFrame(keyframes[i]);
        }
        /**
    ...
    //class laya.display.Input extends laya.display.Text
		...
		*/;
        ...
        __proto._focusIn = function() {
            ...
            this.event("focus");
            if (Browser.onPC || window.WXAPP) input.focus();
            var temp = this._text;
            if (this.editable) {
                this._text = null;
            }
            ...
            if (!Render.isConchApp && Browser.onPC) Laya.timer.frameLoop(1, this, this._syncInputTransform);
        }
        // 设置DOM输入框提示符颜色。
        ;
        ...
        /**表示是否是多行输入框。*/        __getset(0, __proto, "multiline", function() {
		...
		*/        __getset(0, __proto, "maxChars", function() {
        ...
        /**@inheritDoc */        __getset(0, __proto, "text", function() {
            if (this._focus) return this.nativeInput.value; else return this._content || "";
        }, function(value) {
            _super.prototype._$set_color.call(this, this._originColor);
            value += "";
            if (this._focus && !window.WXAPP) {
                ...
                this._content = value;
                if (value) _super.prototype._$set_text.call(this, value); else {
                    _super.prototype._$set_text.call(this, this._prompt);
		...
		*/        __getset(0, __proto, "prompt", function() {
            ...
            if (this._text) _super.prototype._$set_text.call(this, this._text == this._prompt ? value : this._text); else _super.prototype._$set_text.call(this, value);
		...
		*/        __getset(0, __proto, "focus", function() {
            ...
            if (this._focus !== value) {
                if (value) {
                    ...
                    input.blur();
                    if (Render.isConchApp) {
                        input.setPos(-1e4, -1e4);
                    } else if (!window.WXAPP && Input.inputContainer.contains(input)) {
                        Input.inputContainer.removeChild(input);
                    }
                }
            }
        });
        /**限制输入的字符。*/        __getset(0, __proto, "restrict", function() {
		...
		*/        __getset(0, __proto, "type", function() {
            ...
            if (value == "password") this._getCSSStyle().password = true; else this._getCSSStyle().password = false;
            this._type = value;
        });
        /**
		...
		*/        __getset(0, __proto, "inputElementXAdjuster", function() {
        ...
        Input.wxinputFocus = function() {
            console.log("wxinputFocus");
            var _inputTarget = laya.display.Input.inputElement.target;
            ...
            window.wx.onKeyboardConfirm(function(res) {
                ...
                str = Input.faceReplace(str);
                _inputTarget.text = str;
                _inputTarget.event("input");
                laya.display.Input.inputEnter();
            });
        ...
        Input.inputEnter = function() {
            laya.display.Input.inputElement.target.focus = false;
        };
        Input.wxinputblur = function() {
            console.log("wxinputblur");
            Input.hideKeyboard();
        };
        ...
        Input.faceReplace = function(value) {
            var faceStr = value;
            var regRule = /[\uD83C|\uD83D|\uD83E][\uDC00-\uDFFF][\u200D|\uFE0F]|[\uD83C|\uD83D|\uD83E][\uDC00-\uDFFF]|[0-9|*|#]\uFE0F\u20E3|[0-9|#]\u20E3|[\u203C-\u3299]\uFE0F\u200D|[\u203C-\u3299]\uFE0F|[\u2122-\u2B55]|\u303D|[\A9|\AE]\u3030|\uA9|\uAE|\u3030/gi;
            if (faceStr.match(regRule)) {
                faceStr = faceStr.replace(regRule, "");
                if (!window.WXAPP) laya.display.Input.inputElement.value = faceStr;
            }
            var regRule1 = /\uD83C[\uDF00-\uDFFF]|\uD83D[\uDC00-\uDE4F]/g;
            if (faceStr.match(regRule1)) {
                faceStr = faceStr.replace(regRule1, "");
                if (!window.WXAPP) laya.display.Input.inputElement.value = faceStr;
            }
            return faceStr;
        };
        Input._createInputElement = function() {
            ...
            if (window.WXAPP) {
                Input.area.focus = laya.display.Input.wxinputFocus;
                Input.area.blur = laya.display.Input.wxinputblur;
                Input.input.focus = laya.display.Input.wxinputFocus;
                Input.input.blur = laya.display.Input.wxinputblur;
            }
        ...
        __static(Input, [ "IOS_IFRAME", function() {
	...
	*/
    //class laya.display.EffectAnimation extends laya.display.FrameAnimation
        ...
        /**@private */        __proto._onOtherBegin = function(effect) {
    ...
    //class laya.utils.GraphicAnimation extends laya.display.FrameAnimation
		...
		*/;
        ...
        __proto._updateNodeGraphic = function(node, frame, parentTransfrom, g, alpha) {
            ...
            if (!tNodeG.resultTransform) tNodeG.resultTransform = new Matrix();
            var tResultTransform;
            tResultTransform = tNodeG.resultTransform;
            Matrix.mul(tNodeG.transform, parentTransfrom, tResultTransform);
            var tTex;
            var tGraphicAlpha = tNodeG.alpha * alpha;
            if (tGraphicAlpha < .01) return;
            if (tNodeG.skin) {
		...
		*/;
        ...
        __proto._getNodeGraphicData = function(nodeID, frame, rst) {
            ...
            if (rotate || sx !== 1 || sy !== 1 || skewX || skewY) {
                ...
                tm.identity();
                tm.bTransform = true;
                var skx = (rotate - skewX) * .0174532922222222;
                var sky = (rotate + skewY) * .0174532922222222;
                var cx = Math.cos(sky);
                var ssx = Math.sin(sky);
                var cy = Math.sin(skx);
                var ssy = Math.cos(skx);
		...
		*/;
        __proto.setAniData = function(uiView, aniName) {
            if (uiView.animations) {
                ...
                for (i = 0; i < len; i++) {
                    ...
                    var frameO = {};
                    frameO.interval = 1e3 / tAniO["frameRate"];
        ...
        __proto.parseByData = function(aniData) {
            ...
            var frameO = aniData;
            frameO.interval = 1e3 / aniO["frameRate"];
            frameO.frames = this._gList;
            frameO.labels = this._labels;
		...
		*/;
        ...
        __static(GraphicAnimation, [ "_drawTextureCmd", function() {
