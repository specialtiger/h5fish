!function(t, i, e) {
    var s = (e.un, e.uns, e.static), h = e.class, n = e.getset, o = (e.__newvec, laya.display.Animation), l = laya.utils.ClassUtils, r = laya.filters.ColorFilter, a = laya.utils.Ease, c = laya.events.Event, u = laya.display.css.Font, _ = laya.display.FrameAnimation, d = laya.display.Graphics, f = laya.utils.Handler, p = laya.display.Input, g = laya.net.Loader, m = (laya.display.Node, 
    laya.maths.Point), y = laya.maths.Rectangle, C = laya.renders.Render, v = laya.display.Sprite, b = laya.display.Text, S = laya.resource.Texture, x = laya.utils.Tween, w = laya.utils.Utils;
    e.interface("laya.ui.IItem"), e.interface("laya.ui.IRender"), e.interface("laya.ui.ISelect"), 
    e.interface("laya.ui.IComponent"), e.interface("laya.ui.IBox", "IComponent");
    var B = function() {
        function t() {
        ...
        return s.destroy = function() {
            ...
            i.cacheCount++ > 50 && i.clearCache(), this._isChanged = !1;
            var t = this._source;
            if (t && t.bitmap) {
                var e = this.width, s = this.height, h = this._sizeGrid, n = t.sourceWidth, o = t.sourceHeight;
                if (!h || n === e && o === s) this.cleanByTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, e, s); else {
                    t.$_GID || (t.$_GID = w.getGID());
                    var l = t.$_GID + "." + e + "." + s + "." + h.join(".");
                    if (i.cmdCaches[l]) return void (this.cmds = i.cmdCaches[l]);
                    this.clear();
                    var r = h[0], a = h[1], c = h[2], u = h[3], _ = h[4], d = !1;
                    if (u + a > e) {
                        var f = e;
                        d = !0, e = u + a;
                    }
                    d && (this.save(), this.clipRect(0, 0, f, s)), u && r && this.drawTexture(i.getTexture(t, 0, 0, u, r), 0, 0, u, r), 
                    a && r && this.drawTexture(i.getTexture(t, n - a, 0, a, r), e - a, 0, a, r), u && c && this.drawTexture(i.getTexture(t, 0, o - c, u, c), 0, s - c, u, c), 
                    a && c && this.drawTexture(i.getTexture(t, n - a, o - c, a, c), e - a, s - c, a, c), 
                    r && this.drawBitmap(_, i.getTexture(t, u, 0, n - u - a, r), u, 0, e - u - a, r), 
                    c && this.drawBitmap(_, i.getTexture(t, u, o - c, n - u - a, c), u, s - c, e - u - a, c), 
                    u && this.drawBitmap(_, i.getTexture(t, 0, r, u, o - r - c), 0, r, u, s - r - c), 
                    a && this.drawBitmap(_, i.getTexture(t, n - a, r, a, o - r - c), e - a, r, a, s - r - c), 
                    this.drawBitmap(_, i.getTexture(t, u, r, n - u - a, o - r - c), u, r, e - u - a, s - r - c), 
                    d && this.restore(), this.autoCacheCmd && !C.isConchApp && (i.cmdCaches[l] = this.cmds);
                }
                this._repaint();
            }
        ...
        }), i.getTexture = function(t, e, s, h, n) {
            h <= 0 && (h = 1), n <= 0 && (n = 1), t.$_GID || (t.$_GID = w.getGID());
            var o = t.$_GID + "." + e + "." + s + "." + h + "." + n, l = i.textureCache[o];
            return l || (l = i.textureCache[o] = S.createFromTexture(t, e, s, h, n)), l;
        }, i.clearCache = function() {
            i.cacheCount = 0, i.cmdCaches = {}, i.textureCache = {};
        }, i.setCache = function(t, e) {
            i.cacheCount++, i.textureCache[t] = e;
        }, i.getCache = function(t) {
            return i.textureCache[t];
        }, i.cmdCaches = {}, i.cacheCount = 0, i.textureCache = {}, i;
    }(d), z = (function(t) {
        function i() {
            i.__super.call(this);
        }
        h(i, "laya.ui.UIEvent", t), i.SHOW_TIP = "showtip", i.HIDE_TIP = "hidetip", i;
    }(c), function(t) {
        function i() {
            this._comXml = null, this._dataSource = null, this._toolTip = null, this._tag = null, 
            this._disabled = !1, this._gray = !1, this.layoutEnabled = !0, i.__super.call(this), 
            this._layout = B.EMPTY, this.preinitialize(), this.createChildren(), this.initialize();
        }
        ...
        s.callLater = function(t, i) {
            ...
            return this._layout === B.EMPTY && (this._layout = new B()), this._layout;
            ...
            if (isNaN(t.anchorX) || (this.pivotX = t.anchorX * this.width), this.layoutEnabled) {
                var i = this.parent;
                i && (isNaN(t.centerX) ? isNaN(t.left) ? isNaN(t.right) || (this.x = Math.round(i.width - this.displayWidth - t.right + this.pivotX * this.scaleX)) : (this.x = Math.round(t.left + this.pivotX * this.scaleX), 
                isNaN(t.right) || (this.width = (i._width - t.left - t.right) / (this.scaleX || .01))) : this.x = Math.round(.5 * (i.width - this.displayWidth) + t.centerX + this.pivotX * this.scaleX));
            }
        }, s.resetLayoutY = function() {
            var t = this._layout;
            if (isNaN(t.anchorY) || (this.pivotY = t.anchorY * this.height), this.layoutEnabled) {
                var i = this.parent;
                i && (isNaN(t.centerY) ? isNaN(t.top) ? isNaN(t.bottom) || (this.y = Math.round(i.height - this.displayHeight - t.bottom + this.pivotY * this.scaleY)) : (this.y = Math.round(t.top + this.pivotY * this.scaleY), 
                isNaN(t.bottom) || (this.height = (i._height - t.top - t.bottom) / (this.scaleY || .01))) : this.y = Math.round(.5 * (i.height - this.displayHeight) + t.centerY + this.pivotY * this.scaleY));
            }
            ...
            t.prototype._$get_scaleY.call(this) != i && (t.prototype._$set_scaleY.call(this, i), 
            ...
            t.prototype._$get_scaleX.call(this) != i && (t.prototype._$set_scaleX.call(this, i), 
            this.callLater(this.changeSize), this._layout.enable && this.resetLayoutX());
        }), n(0, s, "top", function() {
            ...
            t !== this._gray && (this._gray = t, I.gray(this, t));
        ...
        function i() {
            ...
            }, i.__super.call(this), this.maskLayer = new v(), this.popupEffectHandler = new f(this, this.popupEffect), 
        ...
        return s._closeOnSide = function() {
            ...
            this.lockLayer || (this.lockLayer = new P(), this.lockLayer.mouseEnabled = !0, this.lockLayer.size(e.stage.width, e.stage.height)), 
            ...
            this.lockLayer && this.lockLayer.size(i, s), this.maskLayer.graphics.clear(), this.maskLayer.graphics.drawRect(0, 0, i, s, L.popupBgColor), 
            ...
            void 0 === i && (i = !1), i && this.removeChildren(), t.popupCenter && this._centerDialog(t), 
            this.addChild(t), (t.isModal || this._$P.hasZorder) && this.timer.callLater(this, this._checkMask), 
            null != t.popupEffect ? t.popupEffect.runWith(t) : this.doOpen(t), this.event("open");
        }, s.doOpen = function(t) {
            t.onOpened();
        }, s.lock = function(t) {
            this.lockLayer && (t ? this.addChild(this.lockLayer) : this.lockLayer.removeSelf());
        }, s.close = function(t, i) {
            null != t.closeEffect ? t.closeEffect.runWith([ t, i ]) : this.doClose(t, i), this.event("close");
        }, s.doClose = function(t, i) {
            t.removeSelf(), t.isModal && this._checkMask(), t.closeHandler && t.closeHandler.runWith(i), 
            t.onClosed(i);
        }, s.closeAll = function() {
            this.removeChildren(), this.event("close");
        ...
        function i(t, e) {
            ...
            this._clickHandler = null, this._stateChanged = !1, i.__super.call(this), this._labelColors = k.buttonLabelColors, 
            this._stateNum = k.buttonStateNum, void 0 === e && (e = ""), this.skin = t, this.label = e;
        }
        ...
        return e.imps(o, {
            ...
            this.graphics = this._bitmap = new M();
            ...
            if (this.toggle !== !1 || !this._selected) return "click" === t.type ? (this.toggle && (this.selected = !this._selected), 
            ...
            t.$_GID || (t.$_GID = w.getGID());
            var s = t.$_GID + "-" + this._stateNum, h = M.getCache(s);
            if (h) this._sources = h; else {
                if (this._sources = [], 1 === this._stateNum) this._sources.push(t); else for (var n = 0; n < this._stateNum; n++) this._sources.push(S.createFromTexture(t, 0, e * n, i, e));
                M.setCache(s, this._sources);
            }
            ...
            this._strokeColors = I.fillArray(k.buttonLabelColors, t, String), this._setStateChanged();
        }), n(0, o, "labelColors", function() {
            return this._labelColors.join(",");
        }, function(t) {
            this._labelColors = I.fillArray(k.buttonLabelColors, t, String), this._setStateChanged();
            ...
            this.createText(), this._text.padding = I.fillArray(k.labelPadding, t, Number);
            ...
            this._bitmap.sizeGrid = I.fillArray(k.defaultSizeGrid, t, Number);
        }), n(0, o, "width", t.prototype._$get_width, function(i) {
            t.prototype._$set_width.call(this, i), this._autoSize && (this._bitmap.width = i, 
            this._text && (this._text.width = i));
        }), n(0, o, "height", t.prototype._$get_height, function(i) {
            t.prototype._$set_height.call(this, i), this._autoSize && (this._bitmap.height = i, 
            this._text && (this._text.height = i));
            ...
            this._bitmap._offset = t ? I.fillArray([ 1, 1 ], t, Number) : [];
        ...
        function i(t, e, s) {
            ...
            this._group = null, i.__super.call(this), void 0 === e && (e = 1), void 0 === s && (s = 1), 
            this._clipX = e, this._clipY = s, this.skin = t;
        }
        h(i, "laya.ui.Clip", t);
        var s = i.prototype;
        return s.destroy = function(i) {
            ...
            if (t === this._skin && i) {
                var e = this._clipWidth || Math.ceil(i.sourceWidth / this._clipX), s = this._clipHeight || Math.ceil(i.sourceHeight / this._clipY), h = this._skin + e + s, n = M.getCache(h);
                if (n) this._sources = n; else {
                    this._sources = [];
                    for (var o = 0; o < this._clipY; o++) for (var l = 0; l < this._clipX; l++) this._sources.push(S.createFromTexture(i, e * l, s * o, e, s));
                    M.setCache(h, this._sources);
                }
                this.index = this._index, this.event("loaded"), this.onCompResize();
            }
        }, s.play = function() {
            this._isPlaying = !0, this.index = 0, this._index++, e.timer.loop(this.interval, this, this._loop), 
            this.on("display", this, this._onDisplay), this.on("undisplay", this, this._onDisplay);
        }, s._loop = function() {
            this._style.visible && this._sources && (this.index = this._index, this._index++, 
        ...
        return s.destroy = function(i) {
            ...
            this.addChild(this._colorButton = new H()), this._colorPanel = new P(), this._colorPanel.size(230, 166), 
            this._colorPanel.addChild(this._colorTiles = new v()), this._colorPanel.addChild(this._colorBlock = new v()), 
            ...
            this._colorInput.color = this._inputColor, t = this._colorTiles.graphics, t.clear();
            for (var i = [ 0, 3355443, 6710886, 10066329, 13421772, 16777215, 16711680, 65280, 255, 16776960, 65535, 16711935 ], e = 0; e < 12; e++) for (var s = 0; s < 20; s++) {
                ...
                var n = I.toColor(h);
                this._colors.push(n);
                var o = s * this._gridSize, l = e * this._gridSize;
            ...
            var t = this.localToGlobal(new m()), i = t.x + this._colorPanel.width <= e.stage.width ? t.x : e.stage.width - this._colorPanel.width, s = t.y + this._colorButton.height;
        ...
        function i(t, e) {
            ...
            this._itemColors = k.comboBoxItemColors, this.skin = t, this.labels = e;
        }
        ...
        return s.destroy = function(i) {
            ...
            this.addChild(this._button = new H()), this._button.text.align = "left", this._button.labelPadding = "0,0,0,5", 
            this._button.on("mousedown", this, this.onButtonMouseDown);
        }, s._createList = function() {
            this._list = new F(), this._scrollBarSkin && (this._list.vScrollBarSkin = this._scrollBarSkin), 
            ...
            t.prototype._$set_width.call(this, i), this._button.width = this._width, this._itemChanged = !0, 
            this._listChanged = !0;
            ...
            this._itemColors = I.fillArray(this._itemColors, t, String), this._listChanged = !0;
            ...
            this._isOpen) {
                ...
                var i = this.localToGlobal(m.TEMP.setTo(0, 0)), s = i.y + this._button.height;
            ...
            this._button.text.padding = I.fillArray(k.labelPadding, t, Number);
        ...
        function i(t) {
            ...
            this._offsets = null, i.__super.call(this), this._showButtons = L.showButtons, this._touchScrollEnable = L.touchScrollEnable, 
        ...
        return s.destroy = function(i) {
            ...
            this.addChild(this.slider = new A()), this.addChild(this.upButton = new H()), this.addChild(this.downButton = new H());
        }, s.initialize = function() {
            ...
            this.slide(i), e.timer.once(k.scrollBarDelayTime, this, this.startLoop, [ i ]), 
            ...
            t.prototype.changeSize.call(this), this.resetPositions(), this.event("change"), 
            ...
            this.runCallLater(this.changeSize), this.slider.setSlider(t, i, e), this.slider.bar.visible = i > 0, 
            ...
            x.clearTween(this), e.stage.once("mouseup", this, this.onStageMouseUp2), e.stage.once("mouseout", this, this.onStageMouseUp2), 
            ...
            e.timer.clear(this, this.loop), !this._clickOnly) if (this._target.mouseEnabled = !0, 
            this._isElastic) this._value < this.min ? x.to(this, {
                value: this.min
            }, this.elasticBackTime, a.sineOut, f.create(this, this.elasticOver)) : this._value > this.max && x.to(this, {
                value: this.max
            }, this.elasticBackTime, a.sineOut, f.create(this, this.elasticOver)); else {
            ...
            this._isElastic = !1, !this.hide && this.autoHide && x.to(this, {
                alpha: 0
            }, 500), this.event("end");
            ...
            this.value -= this._lastOffset, Math.abs(this._lastOffset) < 1) {
                if (e.timer.clear(this, this.tweenMove), this._isElastic) return void (this._value < this.min ? x.to(this, {
                    value: this.min
                }, this.elasticBackTime, a.sineOut, f.create(this, this.elasticOver)) : this._value > this.max ? x.to(this, {
                    value: this.max
                }, this.elasticBackTime, a.sineOut, f.create(this, this.elasticOver)) : this.elasticOver());
                this.event("end"), !this.hide && this.autoHide && x.to(this, {
                    alpha: 0
                }, 500);
            }
            ...
            t !== this._value && (this._isElastic ? this._value = t : (this.slider.value = t, 
            this._value = this.slider.value), this.event("change"), this.changeHandler && this.changeHandler.runWith(this.value));
            ...
            this._thumbPercent = t, this.scaleBar && (this.slider.isVertical ? this.slider.bar.height = Math.max(this.slider.height * t, k.scrollBarMinNum) : this.slider.bar.width = Math.max(this.slider.width * t, k.scrollBarMinNum));
        ...
        return o.destroy = function(i) {
            ...
            this.addChild(this._bg = new $()), this.addChild(this._bar = new H());
        }, o.initialize = function() {
            ...
            var i = this._value;
            this.isVertical ? (this._bar.y += (e.stage.mouseY - this._ty) / this._globalSacle.y, 
            ...
            this._progress && (this._progress.height = this._bar.y + .5 * this._bar.height)) : (this._bar.x += (e.stage.mouseX - this._tx) / this._globalSacle.x, 
            ...
            this._tx = e.stage.mouseX, this._ty = e.stage.mouseY;
            ...
            this._progress && (this._progress.height = this._bar.y + .5 * this._bar.height)) : (this._bar.x = (this._value - this._min) / i * (this.width - this._bar.width), 
            this._progress && (this._progress.width = this._bar.x + .5 * this._bar.width));
            ...
            if (this._skin != t) {
                ...
                g.getRes(i) && (this._progress || (this.addChild(this._progress = new $()), this._progress.sizeGrid = this._bar.sizeGrid, 
                this.setChildIndex(this._progress, 1)), this._progress.skin = i), this.setBarPoint(), 
        ...
        return s.destroy = function(i) {
            ...
            this.graphics = this._bitmap = new M(), this._bitmap.autoCacheCmd = !1;
        ...
        function i(t) {
            this._tf = null, i.__super.call(this), void 0 === t && (t = ""), u.defaultColor = k.labelColor, 
            this.text = t;
        }
        h(i, "laya.ui.Label", t);
        var e = i.prototype;
        return e.destroy = function(i) {
            ...
            this._tf.padding = I.fillArray(k.labelPadding, t, Number);
        }), n(0, e, "bold", function() {
            ...
            this._tf.text != t && (t && (t = I.adptString(t + "")), this._tf.text = t, this.event("change"));
        ...
        return e.destroy = function(i) {
            ...
            this.addChild(this._bg = new $()), this.addChild(this._bar = new $()), this._bar._bitmap.autoCacheCmd = !1;
        }, e.changeValue = function() {
            if (this.sizeGrid) {
                var t = this.sizeGrid.split(","), i = Number(t[3]), e = Number(t[1]), s = this.width - i - e, h = s * this._value;
                this._bar.width = i + e + h, this._bar.visible = this._bar.width > i + e;
        ...
        function i() {
            ...
            this._tipBox = new z(), this._tipBox.addChild(this._tipText = new b()), this._tipText.x = this._tipText.y = 5, 
        ...
        s._onStageHideTip = function(t) {
            ...
            var h = t.getBounds();
            t.x = e.stage.mouseX + i, t.y = e.stage.mouseY + s, t.x + h.width > e.stage.width && (t.x -= h.width + i), 
            t.y + h.height > e.stage.height && (t.y -= h.height + s);
        }, s.closeAll = function() {
            ...
            s.clear(), s.drawRect(0, 0, this._tipText.width + 10, this._tipText.height + 10, i.tipBackColor), 
        ...
        return n.createView = function(t) {
            if (t.animations && !this._idMap && (this._idMap = {}), i.createComp(t, this, this), 
            t.animations) {
                var e, s, h = [], n = t.animations, o = 0, l = n.length;
                for (o = 0; o < l; o++) {
                    switch (e = new _(), s = n[o], e._setUp(this._idMap, s), this[s.name] = e, e._setControlNode(this), 
                    s.action) {
                      case 1:
                        e.play(0, !1);
                        break;
            ...
            this._aniList = null, laya.ui.Component.prototype.destroy.call(this, t);
        }, i._regs = function() {
            var t;
            for (t in i.uiClassMap) l.regClass(t, i.uiClassMap[t]);
        }, i.createComp = function(t, s, h) {
            if (!(s = s || i.getCompInstance(t))) return console.warn("can not create:" + t.type), 
            null;
            var n = t.child;
            if (n) for (var o = 0, r = n.length; o < r; o++) {
                var a = n[o];
                if (!s.hasOwnProperty("itemRender") || "render" != a.props.name && "render" !== a.props.renderType) if ("Graphic" == a.type) l.addGraphicsToSprite(a, s); else if (l.isDrawType(a.type)) l.addGraphicToSprite(a, s, !0); else {
            ...
            return e.__typeof(s, "laya.ui.IItem") && s.initItems(), t.compId && h && h._idMap && (h._idMap[t.compId] = s), 
            s;
            ...
            return s = h ? i.viewClassMap[h] || i.uiClassMap[h] || e.__classmap[h] : i.uiClassMap[t.type], 
        ...
        return e.createChildren = function() {
            this._bitmap = new M(), this.on("loaded", this, this._onClipLoaded);
        ...
        function i() {
            ...
            this._cellChanged = !1, i.__super.call(this), this._cells = [], this._offset = new m();
        }
        h(i, "laya.ui.List", t);
        var s = i.prototype;
        return e.imps(s, {
            ...
            this.addChild(this._content = new P());
        }, s.onScrollStart = function() {
            this._$P.cacheAs || (this._$P.cacheAs = t.prototype._$get_cacheAs.call(this)), t.prototype._$set_cacheAs.call(this, "none"), 
            ...
            if (this._cellChanged = !1, this._itemRender) {
                ...
                this._isVertical && this._scrollBar ? this._scrollBar.height = h : !this._isVertical && this._scrollBar && (this._scrollBar.width = s), 
            ...
            if (0 === this._cells.length) {
                ...
                this._offset.setTo(t.x, t.y), this._cells.push(t);
            }
            ...
            if (this.cacheContent) {
                var l = new P();
                l.cacheAsBitmap = !0, l.pos((this._isVertical ? 0 : t) * n, (this._isVertical ? t : 0) * o), 
                this._content.addChild(l), this._content.optimizeScrollRect = !0, s = l;
            }
            ...
            for (var u = t; u < e; u++) for (var _ = 0; _ < i; _++) h = r.length ? r.pop() : this.createItem(), 
            h.x = (this._isVertical ? _ : u) * n - s.x, h.y = (this._isVertical ? u : _) * o - s.y, 
            h.name = "item" + (u * i + _), s.addChild(h), this.addCell(h);
        }, s.createItem = function() {
            return "function" == typeof this._itemRender ? new this._itemRender() : D.createComp(this._itemRender);
            ...
            this._content.width = t, this._content.height = i, (this._scrollBar || 0 != this._offset.x || 0 != this._offset.y) && (this._content.scrollRect || (this._content.scrollRect = new y()), 
            this._content.scrollRect.setTo(-this._offset.x, -this._offset.y, t, i), this._content.conchModel && this._content.conchModel.scrollRect(-this._offset.x, -this._offset.y, t, i)), 
            this.event("resize");
            ...
            this._createdLine += o, this.renderItems(this._createdLine * e, 0)); else {
                var n = h * e, o = 0;
                if (n > this._startIndex) {
                    o = n - this._startIndex;
                    var l = !0, r = this._startIndex + e * (s + 1);
                    this._isMoved = !0;
                } else n < this._startIndex && (o = this._startIndex - n, l = !1, r = this._startIndex - 1, 
                this._isMoved = !0);
                for (var a = 0; a < o; a++) {
                    if (l) {
            ...
            d.x = i - this._offset.x), this._content.conchModel && this._content.conchModel.scrollRect(d.x, d.y, d.width, d.height), 
            this.repaint();
            ...
            this._array && i >= 0 && i < this._array.length ? (t.visible = !0, t.dataSource = this._array[i], 
            this.cacheContent || this.posCell(t, i), this.hasListener("render") && this.event("render", [ t, i ]), 
            this.renderHandler && this.renderHandler.runWith([ t, i ])) : (t.visible = !1, t.dataSource = null);
        }, s.refresh = function() {
            ...
            t.prototype._$set_cacheAs.call(this, i), this._scrollBar && (this._$P.cacheAs = null, 
            "none" !== i ? this._scrollBar.on("start", this, this.onScrollStart) : this._scrollBar.off("start", this, this.onScrollStart));
            ...
            var i = new tt();
            i.name = "scrollBar", i.right = 0, t && " " != t && (i.skin = t), this.scrollBar = i, 
            this.addChild(i), this._setCellChanged();
        }), n(0, s, "page", function() {
            return this._page;
        }, function(t) {
            ...
            this._removePreScrollBar();
            var i = new U();
            i.name = "scrollBar", i.bottom = 0, t && " " != t && (i.skin = t), this.scrollBar = i, 
            this.addChild(i), this._setCellChanged();
        ...
        function i() {
            ...
            i.__super.call(this), this.width = this.height = 100, this._content.optimizeScrollRect = !0;
        }
        h(i, "laya.ui.Panel", t);
        var e = i.prototype;
        return e.destroy = function(t) {
            ...
            laya.display.Node.prototype.addChild.call(this, this._content = new P());
            ...
            var t = this.contentWidth || 1, i = this.contentHeight || 1, e = this._vScrollBar, s = this._hScrollBar, h = e && i > this._height, n = s && t > this._width, o = h ? this._width - e.width : this._width, l = n ? this._height - s.height : this._height;
            e && (e.x = this._width - e.width, e.y = 0, e.height = this._height - (n ? s.height : 0), 
            e.scrollSize = Math.max(.033 * this._height, 1), e.thumbPercent = l / i, e.setScroll(0, i - l, e.value)), 
            ...
            var e = this._content;
            e.width = t, e.height = i, e.scrollRect || (e.scrollRect = new y()), e.scrollRect.setTo(0, 0, t, i), 
            e.conchModel && e.conchModel.scrollRect(0, 0, t, i);
            ...
            null == this._hScrollBar && (laya.display.Node.prototype.addChild.call(this, this._hScrollBar = new U()), 
            ...
            null == this._vScrollBar && (laya.display.Node.prototype.addChild.call(this, this._vScrollBar = new tt()), 
            ...
            t.prototype._$set_cacheAs.call(this, i), this._$P.cacheAs = null, "none" !== i ? (this._hScrollBar && this._hScrollBar.on("start", this, this.onScrollStart), 
        ...
        return e.imps(s, {
            ...
            if (e != -1) {
                ...
                if (this.initItems(), this._selectedIndex > -1) {
                    var l = 0;
                    l = this._selectedIndex < this._items.length ? this._selectedIndex : this._selectedIndex - 1, 
                    this._selectedIndex = -1, this.selectedIndex = l;
                }
            }
        }, s.initItems = function() {
        ...
        return h(i, "laya.ui.HSlider", t), i;
    }(A), Z = function(t) {
        function i(t, e) {
        ...
        return e.imps(s, {
            ...
            this.addChild(this._list = new F()), this._list.renderHandler = f.create(this, this.renderItem, null, !1), 
            ...
            if (!s) {
                ...
                for (var a in r) {
                    l = r[a];
                    var c = l.nodeName, u = l.nodeValue;
            ...
            var s;
            for (var h in t) s = t[h], !s.isDirectory && String(s.label).toLowerCase().indexOf(e) > -1 && (s.x = 0, 
        ...
        return h(i, "laya.ui.VScrollBar", t), i;
    }(X), it = function(t) {
        function i(t) {
        ...
        return e.preinitialize = function() {
            ...
            this.addChild(this._tf = new p()), this._tf.padding = k.inputLabelPadding, this._tf.on("input", this, this._onInput), 
            ...
            this._skin != t && (this._skin = t, this._bg || (this.graphics = this._bg = new M()), 
            this._bg.source = g.getRes(this._skin), this._width && (this._bg.width = this._width), 
            this._height && (this._bg.height = this._height));
        }), n(0, e, "sizeGrid", function() {
            return this._bg && this._bg.sizeGrid ? this._bg.sizeGrid.join(",") : null;
        }, function(t) {
            this._bg || (this.graphics = this._bg = new M()), this._bg.sizeGrid = I.fillArray(k.defaultSizeGrid, t, Number);
        ...
        return h(i, "laya.ui.VSlider", t), i;
    }(A), st = function(t) {
        function i() {
            this.popupCenter = !0, this.closeHandler = null, this.popupEffect = null, this.closeEffect = null, 
            this.group = null, this.isModal = !1, this._dragArea = null, i.__super.call(this);
        }
        ...
        return e.initialize = function() {
            ...
            void 0 === t && (t = !1), this._open(!1, t);
        }, e.popup = function(t) {
            void 0 === t && (t = !1), this._open(!0, t);
        }, e._open = function(t, e) {
            i.manager.lock(!1), this.isModal = t, i.manager.open(this, e);
        }, e.onOpened = function() {}, e.close = function(t) {
            i.manager.close(this, t);
            ...
            if (t) {
                var i = I.fillArray([ 0, 0, 0, 0 ], t, Number);
            ...
            return i._manager = i._manager || new T();
        }, function(t) {
            i._manager = t;
        ...
        }, i.CLOSE = "close", i.CANCEL = "cancel", i.SURE = "sure", i.NO = "no", i.OK = "ok", 
        i.YES = "yes", i._manager = null, i;
    }(D), ht = function(t) {
        function i() {
            i.__super.call(this);
        }
        ...
        return e.sortItem = function(t) {
            ...
            this.sortItem(t);
            var n = 0;
            for (e = 0, s = t.length; e < s; e++) h = t[e], h.x = n, n += h.width * h.scaleX + this._space, 
        ...
        return e.changeItems = function() {
            ...
            this.sortItem(t);
            var n = 0;
            for (e = 0, s = t.length; e < s; e++) h = t[e], h.y = n, n += h.height * h.scaleY + this._space, 
        ...
        return h(i, "laya.ui.RadioGroup", t), i.prototype.createItem = function(t, i) {
            return new Z(t, i);
        }, i;
    }(q), lt = function(t) {
        function i() {
        ...
        return h(i, "laya.ui.Tab", t), i.prototype.createItem = function(t, i) {
            return new H(t, i);
        }, i;
    }(q), rt = function(t) {
        function i(t) {
        ...
        return e.destroy = function(i) {
            ...
            var t = this._vScrollBar && this._tf.maxScrollY > 0, i = this._hScrollBar && this._tf.maxScrollX > 0, e = t ? this._width - this._vScrollBar.width : this._width, s = i ? this._height - this._hScrollBar.height : this._height, h = this._tf.padding || k.labelPadding;
            ...
            null == this._vScrollBar && (this.addChild(this._vScrollBar = new tt()), this._vScrollBar.on("change", this, this.onVBarChanged), 
            this._vScrollBar.target = this._tf, this.callLater(this.changeScroll)), this._vScrollBar.skin = t;
        }), n(0, e, "hScrollBarSkin", function() {
            return this._hScrollBar ? this._hScrollBar.skin : null;
        }, function(t) {
            null == this._hScrollBar && (this.addChild(this._hScrollBar = new U()), this._hScrollBar.on("change", this, this.onHBarChanged), 
    ...
    !function(t) {
        ...
        h(i, "laya.ui.AsynDialog", t);
        var e = i.prototype;
        e.createView = function(t) {
            this._uiView = t;
        }, e._open = function(t, i) {
            this.isModal = t, this.isCloseOther = i, st.manager.lock(!0), this._uiView ? this.onCreated() : this.onOpen();
