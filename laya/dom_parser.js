...
DOMParser.prototype.parseFromString = function(t, e) {
    ...
    startElement: function(t, e, n, r) {
        ...
        for (var c = 0; a > c; c++) {
            var t = r.getURI(c), l = r.getValue(c), n = r.getQName(c), s = o.createAttributeNS(t, n);
    ...
    characters: function(t) {
        if (t = _toString.apply(this, arguments)) {
            if (this.cdata) var e = this.doc.createCDATASection(t); else var e = this.doc.createTextNode(t);
