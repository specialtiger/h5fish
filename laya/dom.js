    ...
    switch (e.nodeType) {
      case ELEMENT_NODE:
        ...
        if (needNamespaceDefine(e, n, i)) {
            var N = e.prefix || "", l = e.namespaceURI, p = N ? " xmlns:" + N : " xmlns";
            t.push(p, '="', l, '"'), i.push({
                prefix: N,
                namespace: l
            });
      ...
      case DOCUMENT_FRAGMENT_NODE:
        for (var s = e.firstChild; s; ) serializeToString(s, t, n, o, i), s = s.nextSibling;
        return;
...
DOMException.prototype = Error.prototype, copy(ExceptionCode, DOMException), NodeList.prototype = {
    ...
    createElement: function(e) {
        var t = new Element();
        t.ownerDocument = this, t.nodeName = e, t.tagName = e, t.childNodes = new NodeList();
...
CharacterData.prototype = {
    ...
    replaceData: function(e, t, n) {
        var o = this.data.substring(0, e), i = this.data.substring(e + t);
        n = o + n + i, this.nodeValue = this.data = n, this.length = n.length;
    }
